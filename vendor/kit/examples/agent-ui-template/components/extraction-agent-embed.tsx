...
const agentId = "extraction-agent" as const;
const profile = agentProfiles[agentId];

export function ExtractionAgentEmbed() {
			...
			>
				{isEmpty && (
					<header className="space-y-2 px-1 text-left">
						...
						<p className="text-muted-foreground text-xs">
							Files live under{" "}
							<code className="text-foreground">data/extraction-agent.local/</code>
							. Try paths like{" "}
							<code className="text-foreground">invoices/acme.pdf</code>,{" "}
							<code className="text-foreground">sales/q2.xlsx</code>,{" "}
							<code className="text-foreground">receipts/cafe.png</code>.
						</p>
					</header>
				)}
				...
				<section className="w-full shrink-0">
					<form onSubmit={handleSubmit}>
						...
						>
							<PromptInputTextarea
								placeholder="Ask to extract from a PDF, spreadsheet, or image..."
